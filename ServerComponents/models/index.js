...
const Account = require('./Accounts.js').default(sequelize, Sequelize.DataTypes);
const Category = require('./Categories.js').default(sequelize, Sequelize.DataTypes);
const Channel = require('./Channels.js').default(sequelize, Sequelize.DataTypes);
const Comment = require('./Comments.js').default(sequelize, Sequelize.DataTypes);
